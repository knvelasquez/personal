...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/blueviolet.css" />
    <!-- Template JS Files -->
        ...
        <div id="bl-main" class="bl-main">
                        ...
                        <div class="title-heading">
                            <div class="selector uppercase" id="selector">
                                <h3 class="ah-headline p-none m-none">
									<span class="my-name">Kevin V.</span>
                                    <span class="ah-words-wrapper">
										<b class="is-visible">Senior Developer</b>
										<b>Wordpress plugins</b>
										<b>Wordpress themes</b>
										<b>Html5</b>
										<b>jQuery</b>
										<b>Bootstrap</b>
										<b>Mailchimp</b>
                    ...
                    <div class="container infos">
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m8 l12 xl12 personal-info section-padding">
								...
								<div class="col m12 l12 xl9 p-none" style="text-align: justify;width: 100%;">
									<p class="second-font">I'm a senior developer with solid understanding of 
									Java, jQuery, Bootstrap, Angular, NodeJS, HTML5, CSS3, skilled for solving complex problems and strong in Spring,Hibernate,Oracle,SDA,Github,C#.
									Expert debugger for Problem solving, multitasking and project management methodologies.
									
									Looking for an ambitious company which will challenge my developer skills and allow me to continue to develop my potential.									
									</p>
								</div>
                                <div class="col s12 m12 l6 p-none">
                                    <ul class="second-font list-1">
                                        <li><span class="font-weight-700">First Name: </span>Kevin</li>
                                        <li><span class="font-weight-700">Last Name: </span>Velásquez</li>
                                        <li><span class="font-weight-700">Date of birth: </span>29 march 1989 </li>
                                ...
                                <div class="col s12 m12 l6 p-none">
                                    <ul class="second-font list-2">                                     
                                        <li><span class="font-weight-700">Email: </span>knvelasquez@hotmail.com</li>
                                        <li><span class="font-weight-700">Spoken Languages: </span>Spanish - English</li>
										<li><span class="font-weight-700">Skype: </span>knvelasquez</li>
                                    </ul>
                                </div>
			...
			<!-- About Title Starts -->
                <div class="bl-box valign-wrapper">
                    <div class="page-title center-align">
                        <h2 class="center-align">
                            <span data-hover="Exper">Skill</span>
                            <span data-hover="ience">s</span>
                        </h2>
                    </div>
                </div>
                <div class="bl-content">
					<!-- Resume Starts -->
					<div class="resume-container" style="padding: 0;margin: 0;">
                        <div class="container">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s6">
                                                            ...
                                                            <div class="resume-content">
																...
																<p><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></i></p>
                                                            </div>
															<!-- Single Skills Ends -->
                                                            ...
                                                            <div class="resume-content">
																...
																<p><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i><i class="fa fa-star"></i> <i class="fa fa-star-o"></i></p>
                                                            </div>
															<!-- Single Skills Ends -->
															<!-- Single Skills Starts -->
                                                            <div class="resume-content">
																<h6 class="uppercase">CS3</h6>
																<p>
															...
															<div class="resume-content">
																<h6 class="uppercase">Mailchimp</h6>
																<p>
																	<i class="fa fa-star"></i> 
																	<i class="fa fa-star"></i> 
																	<i class="fa fa-star"></i>  
                                                        ...
                                                        <div class="col s6">
															...
															<!-- Single Skills Ends -->
															<div class="resume-content">
																<h6 class="uppercase">AngularJS</h6>
																<p>
																	<i class="fa fa-star"></i> 
																	<i class="fa fa-star"></i> 
																</p>
                                        ...
                                        <div class="resume-card resume-card-1" data-index="1">
                                            ...
                                            <div class="resume-card-body experience">
                                                <div class="resume-card-body-container second-font">
                                                    ...
                                                    <div class="resume-content">
														<h6 class="uppercase"><span>Senior Java Developer - </span>Santander Technology.</h6>
														<span class="date">Buenos Aires - Argentina <i class="fa fa-calendar-o"></i>(Current)</span>
														<p>• Java 8 Development for new applications, components & functionality to existing systems.  
															• Spring,Hibernate and Oracle 
															• Team Foundation(TFS) for sharing source code. 
															</p>
                                                    </div>
													...
													<!-- Single Experience Starts -->
                                                    <div class="resume-content">
														<h6 class="uppercase"><span>Senior Java Developer - </span>Suiche7b, C.A.</h6>
														<span class="date">Caracas - Venezuela <i class="fa fa-calendar-o"></i> 2015 - 2017</span>
														<p>• Developing new applications, components & functionality to existing systems 
														   • Developing new functionalities, both back-end and front-end</p>
                                                    </div>
													<!-- Single Experience Ends -->
                                                    <span class="separator"></span>
													<!-- Single Experience Starts -->
                                                    <div class="resume-content">
														<h6 class="uppercase"><span>IT Analyst - </span>Banesco Banco, C.A.</h6>
														<span class="date">Caracas - Venezuela <i class="fa fa-calendar-o"></i> 2006 - 2015</span>
														<p>• Support to internal users.
														   • Development in ASP .NET Framework 3.5 and Javascript.
														</p>
                                                    </div>
													<!-- Single Experience Ends -->
                                                </div>
                                        ...
                                        <div class="resume-card resume-card-2" data-index="2">
                                            ...
                                            <div class="resume-card-body education">
                                                <div class="resume-card-body-container second-font">
                                                    ...
                                                    <div class="resume-content">
														<h6 class="uppercase"><span>Java SE 8 Fundamentals - </span>Oracle</h6>
														<span class="date"><i class="fa fa-calendar-o"></i> 2016</span>
														<p>Java Certification Programm</p>
                                                    </div>
													<!-- Single Education Ends -->
                                                    <span class="separator"></span>
													<!-- Single Education Starts -->
                                                    <div class="resume-content">
														<h6 class="uppercase"><span>Twenty C# Questions Answered - </span>Microsoft Virtual Academy</h6>
														<span class="date"><i class="fa fa-calendar-o"></i> 2016</span>
														<p>This training session focuses on 20 of the top questions surrounding the C# language, based on number of views and votes on stackoverflow. Watch this session, and get your questions answered.
</p>
                                                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row contact section-padding">
                            ...
                            <div class="col s12 m5 l5 xl4 leftside">
								...
								<span class="font-weight-400 second-font"><i class="fa fa-envelope"></i> knvelasquez@hotmail.com</span>
								<h6 class="font-weight-700 uppercase">Skype</h6>
								<span class="font-weight-400 second-font"><i class="fab fa-skype"></i> knvelasquez</span>
                                ...
                                <div class="social">
									<ul class="list-inline social social-intro center-align p-none">
										<li class="linkedin"><a href="https://www.linkedin.com/in/knvelasquez/" target="_blank"><i class="fab fa-linkedin"></i></a></li>
										<li class="facebook"><a href="https://github.com/knvelasquez" target="_blank"><i class="fab fa-github"></i></a></li>
										<li class="google-plus"><a href="https://www.instagram.com/knvelasquez/" target="_blank"><i class="fab fa-instagram"></i></a></li>
                                        <li class="twitter"><a href="#"><i class="fas fa-qrcode"></i></a></li> 									
                                    </ul>
                                </div>
                            ...
                            <div class="col s12 m7 l7 xl8 rightside">
                                <form class="contactform" method="post" action="send_email.php">
                                    <!-- Name Field Starts -->
